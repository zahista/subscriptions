...
<body>
    ...
    <header class="bg-gray-100 shadow-xl w-full h-8">
        //---
    </header>


    <main class="bg-zinc-100 h-[70vh] flex items-center justify-center">

        <div class="w-2/3 flex flex-col justify-center items-center gap-6">
            <h1 class="text-6xl font-bold text-center text-gray-800">Sledujte předplatné. Spravujte výdaje. Mějte
                kontrolu nad
                platbami.</h1>
            <p class="text-center text-gray-700">Naše aplikace pro správu předplatných vám umožní snadno sledovat, kam a
                z jakých karet
                odchází vaše
                platby. Připojte své předplatné, získejte detailní přehled o výdajích a nikdy nezapomeňte na žádnou
                platbu. Bezpečně, efektivně a jednoduše.</p>
            <a href="/login" class="text-white bg-gray-900 rounded-full px-6 py-4 text-lg">Vyzkoušet zdarma</a>
        </div>

    </main>

    <div class="py-24 sm:py-32 relative -top-64">
